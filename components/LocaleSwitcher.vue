...
<script lang="ts">
  ...
  export default class HeaderNavigation extends Vue {
    ...
    get inCharClass () {
      return (this.locale === "in" && !this.clicked) || (this.locale === "en" && this.clicked) ? "char--selected" : "char--unselected";
    }

    get enCharClass () {
      return (this.locale === "en" && !this.clicked) || (this.locale === "in" && this.clicked) ? "char--selected" : "char--unselected";
    }
    ...
    goAnotherLocale () {
      const anotherLocale = `${this.locale === "en" ? process.env.productionUrlIn : process.env.productionUrlEn }${this.$route.path}`;
